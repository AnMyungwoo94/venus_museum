    ...
    <div id="board_box">
      ...
      <ul class="buttons">
        ...
        if ($userid == "admin") {
          ...
          echo "<li><button hidden onclick= \"location.href='board_modify_form.php?num=$num &page= $page'\">수정</button></li>";
        }
        ?>
        <?php
        if ($userid == "admin") {
          ...
          echo " <li><button hidden onclick=\"location.href='board_delete.php?num= $num &page= $page '\">삭제</button></li>";
        }
        ?>

        <!-- <li><button hidden onclick="location.href='board_modify_form.php?num=<?= $num ?>&page=<?= $page ?>'">수정</button></li> -->
